...
@Autonomous(name="RedDelayDriveShoot", preselectTeleOp = "Drive Robot")
public class RedDriveDelayShoot extends CommandOpMode {
   ...
   //     robot.startVisionProcessor(visionProcessor1);
     ...
     //   robot.getArm().grabClose();
        ...
        schedule(new AutoDriveShootCommand(robot, TeamPropDetector.AllianceColor.RED, AutonConstants.DELAYSTART_SECS ));
    }
